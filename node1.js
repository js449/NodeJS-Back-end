//to run the program use node .\file_name
//press tab twice = for get all the node modules
//to exit = .exit or twice(ctrl+c)
...
const server = http.createServer((req, res) => {
  res.statusCode = 200;
  res.setHeader('Content-Type', 'text/html'); //instead of http change to html for html content
//   res.end('Hello World this is Jagdeep Singh');
